...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary" style="background-color:#fed2d2;border-width:0px;color:black">My Quiz List</div>
		<br>
		<div class="card">
			<div class="card-body">
					...
					<tr>
						...
						<td>
							<center>
							 	...
							 	<a class="btn btn-sm btn-outline-danger" href="./answer_sheet.php?id=<?php echo $row['id']?>"><i class="fa fa-pencil"></i> Take Quiz</a>
								<?php else: ?>
								<a class="btn btn-sm btn-outline-danger" href="./view_answer.php?id=<?php echo $row['id']?>"><i class="fa fa-eye"></i> View</a>
							<?php endif; ?>
							</center>
						</td>
					</tr>
