...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary" style="background-color:#fed2d2;border-width:0px;color:black"><?php echo $qry['title'] ?></div>
		<button class="btn btn-primary bt-sm" id="new_question" style="background-color:#900;border-width:0px;"><i class="fa fa-plus"></i>	Add Question</button>
		<button class="btn btn-primary bt-sm" id="new_student" style="background-color:#900;border-width:0px;"><i class="fa fa-plus"></i>	Add Student</button>
		<br>
		<br>
