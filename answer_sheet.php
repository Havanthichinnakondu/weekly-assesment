...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-danger"><?php echo $quiz['title'] ?> | <?php echo $quiz['qpoints'] .' Points Each Question' ?></div>
		<br>
		<div class="card">
			<div class="card-body">
				...
				<?php } ?>
				<button class="btn btn-block btn-primary" style="background-color:#900;border-width:0px;">Submit</button>
				</form>
			</div>	
		</div>
	</div>
